...
import { listAllTiposProducto, deleteTipoProducto } from '../../Api/Api'
...
const TiposProducto = () => {
    ...
    const handleDelete = async () => {
        ...
        if(response && response.status === 200) {
            await getTiposProductos();
            setResponseData( {title: "Operación exitosa", message: "Se eliminó con éxito el tipo de producto." });
        } else {
    ...
    return (
        <>
            <ListContainer
                ...
                textButton='Agregar Tipo de Producto' registerPermission={registerPermission} refreshFunction={refreshFunction}
            />
