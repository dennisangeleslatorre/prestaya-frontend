...
const systemModules = {
    commercialModule: ['CLIENTES', 'PRÉSTAMOS', 'FLUJO CAJA USUARIOS', 'TRANSACCIONES TIENDA', 'PRODUCTOS','FLUJO CAJA TIENDA'],
    masterModule: [ 'AGENCIAS', 'COMPAÑÍAS', 'DEPARTAMENTOS', 'DISTRITOS', 'PAÍSES', 'PARÁMETROS', 'PERÍODOS', 'PROVINCIAS',
    'TIPOS DE DOCUMENTO', 'TIPOS DE PRODUCTO', 'SUBTIPOS DE PRODUCTO', 'UNIDADES DE MEDIDA', 'TIPOS DE MOVIMIENTOS DE CAJA',
    'UBICACIONES DE AGENCIA', 'TIPOS DE MOVIMIENTOS DE CAJA TIENDA'],
    ...
    'REPORTE TRANSACCIONES TIENDA', 'REPORTE PRESTAMO DETALLADO POR FECHA CANCELACION', 'REPORTE UBICACIONES DE PRESTAMOS',
    'REPORTE PRODUCTOS TIENDA', 'REPORTE FLUJO DE CAJA TIENDA']
}
