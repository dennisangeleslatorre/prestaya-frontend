...
const ContratoPDFComponent = (props) => (
    <Document>
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.header__container}>
                <View style={styles.row__header__container}>
                    <View style={styles.column__header__container}>
                        <Text style={styles.header__text}>Agencia: </Text>
                    </View>
                    <View style={styles.column__header__container}>
                        <Text style={styles.header__text}>Fecha: </Text>
                    </View>
                </View>
                <View style={styles.row__header__container}>
                    <View style={styles.column__header__container}>
                        <Text style={styles.header__text}>Cliente: </Text>
                    </View>
                    <View style={styles.column__header__container}>
                        <Text style={styles.header__text}>Contrato: </Text>
                    </View>
                </View>
                <View style={styles.row__header__container}>
                    <Text style={styles.header__text}>D.O.I: </Text>
                </View>
                <View style={styles.row__header__container}>
                    <Text style={styles.header__text}>Dirección: </Text>
                </View>
            </View>
            <View style={styles.body__container}>
                <View style={styles.body__section}>
                    ...
                    <View style={styles.row__header__container}>
                        <View style={styles.column__header__container}>
                            <Text style={styles.body__text}>Tasa Efectiva Anual      :  'aqui'</Text>
                        </View>
                        <View style={styles.column__header__container}>
                            <Text style={styles.body__text}>Moneda   :  'aqui'</Text>
                        </View>
                    </View>
                    <View style={styles.row__header__container}>
                        <View style={styles.column__header__container}>
                            <Text style={styles.body__text}>Monto del Préstamo     :  'aqui'</Text>
                        </View>
                        <View style={styles.column__header__container}>
                            <Text style={styles.body__text}>Plazo       :  'aqui'</Text>
                        </View>
                    </View>
                    <View style={styles.row__header__container}>
                        <View style={styles.column__header__container}>
                            <Text style={styles.body__text}>Fecha de Préstamo      :  'aqui'</Text>
                        </View>
                        <View style={styles.column__header__container}>
                            <Text style={styles.body__text}>Producto  :  'aqui'</Text>
                        </View>
                    </View>
                    <View style={styles.row__header__container}>
                        <Text style={styles.body__text}>Fecha de Vencimiento  :  'aqui'</Text>
                    </View>
                    <View style={styles.row__header__container}>
                        ...
                        </View>
                        {
                            arrayI.map((item,index) => (
                                <View style={styles.table__row__container} key={index}>
                                    <View style={styles.table__column__container}>
                                        <Text style={styles.table__text}>{item.type}</Text>
                                    </View>
                                    <View style={styles.table__column__container}>
                                        <Text style={styles.table__text}>{item.capital}</Text>
                                    </View>
                                    <View style={styles.table__column__container}>
                                        <Text style={styles.table__text}>{item.interest}</Text>
                                    </View>
                                    <View style={styles.table__column__container}>
                                        <Text style={styles.table__text}>{item.total}</Text>
                                    </View>
                                </View>
                            ))
                        }
                ...
                <View style={styles.body__section}>
                    ...
                    <View style={styles.row__header__container}>
                        <Text style={styles.body__paragrah}>El plazo de duración del préstamo es de 30 días calendarios contados a partir de la fecha de este documento a cuyo vencimiento “EL CIENTE “para cumplir con su obligación podrá optar por algunos de las siguientes alternativas.</Text>
                        ...
                        <Text style={styles.body__multi__paragraph}>SOLO SE COBRARÁ PENALIDAD de S/10.00(00/100) soles, si se realizara una Cancelación de contrato en los próximos 1 a 10 días después de generarse el préstamo.</Text>
                        <Text style={styles.body__multi__paragraph}>          Además de los 30 días de plazo de duración del préstamo “EL PRESTATARIO” cuenta con 20 días adicionales antes del remate de su prenda.</Text>
                    </View>
                    <View style={styles.row__header__container}>
